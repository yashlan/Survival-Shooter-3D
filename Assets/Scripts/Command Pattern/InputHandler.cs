...
public class InputHandler : MonoBehaviour
{
    ...
    Command InputMovementHandling()
    {
        ...
        if (Input.GetKey(KeyCode.D))      return new MoveCommand(playerMovement,  1,  0);
        else if (Input.GetKey(KeyCode.A)) return new MoveCommand(playerMovement, -1,  0);
        else if (Input.GetKey(KeyCode.W)) return new MoveCommand(playerMovement,  0,  1);
        else if (Input.GetKey(KeyCode.S)) return new MoveCommand(playerMovement,  0, -1);
        else if (Input.GetKey(KeyCode.Z)) return Undo(); //undo movement
        else return new MoveCommand(playerMovement, 0, 0);
    }
